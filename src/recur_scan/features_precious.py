...
def get_relative_amount_difference(transaction: Transaction, all_transactions: list[Transaction]) -> float:
    """Extract relative amount difference."""
    ...
    return relative_amount_difference
