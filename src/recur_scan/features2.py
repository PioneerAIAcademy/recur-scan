...
def get_features_at(transaction: Transaction, all_transactions: list[Transaction]) -> dict[str, float | int]:
    ...
    return {
        "n_transactions_same_amount_at": same_amount,
        "percent_transactions_same_amount_at": same_amount / total_txns if total_txns else 0.0,
        "percent_transactions_same_amount_tolerant_at": same_amount_tolerant / total_txns if total_txns else 0.0,
        "ends_in_99_at": get_ends_in_99_at(transaction),
        "amount": transaction.amount,
        "same_day_exact_at": get_n_transactions_same_day_at(transaction, all_transactions, 0),
        "pct_transactions_same_day_at": get_pct_transactions_same_day_at(transaction, all_transactions, 0),
        "same_day_off_by_1_at": get_n_transactions_same_day_at(transaction, all_transactions, 1),
        "same_day_off_by_2_at": get_n_transactions_same_day_at(transaction, all_transactions, 2),
        "14_days_apart_exact_at": get_n_transactions_days_apart_at(transaction, all_transactions, 14, 0),
        "pct_14_days_apart_exact_at": get_pct_transactions_days_apart_at(transaction, all_transactions, 14, 0),
        "14_days_apart_off_by_1_at": get_n_transactions_days_apart_at(transaction, all_transactions, 14, 1),
        "pct_14_days_apart_off_by_1_at": get_pct_transactions_days_apart_at(transaction, all_transactions, 14, 1),
        "7_days_apart_exact_at": get_n_transactions_days_apart_at(transaction, all_transactions, 7, 0),
        "pct_7_days_apart_exact_at": get_pct_transactions_days_apart_at(transaction, all_transactions, 7, 0),
        "7_days_apart_off_by_1_at": get_n_transactions_days_apart_at(transaction, all_transactions, 7, 1),
        "pct_7_days_apart_off_by_1_at": get_pct_transactions_days_apart_at(transaction, all_transactions, 7, 1),
        "is_insurance": get_is_insurance_at(transaction),
        "is_utility_at": get_is_utility_at(transaction),
