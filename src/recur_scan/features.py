...
#     """Check if the transaction is related to utilities."""
#     keywords = ["utility", "electricity", "water", "gas", "energy"]
#     return any(keyword in transaction.name.lower() for keyword in keywords)


# def get_is_phone(transaction: Transaction) -> bool:
#     """Check if the transaction is related to phone services."""
#     keywords = ["phone", "mobile", "cellular"]
#     return any(keyword in transaction.name.lower() for keyword in keywords)


# def get_n_transactions_days_apart(
#     transaction: Transaction, all_transactions: list[Transaction], days: int, n_days_off: int = 0
# ) -> int:
#     """Count the number of transactions that occur exactly `days` apart, allowing for an offset of `n_days_off`."""
...
#         if abs((t_date - transaction_date).days - days) <= n_days_off:
#             count += 1
#     return count
...
#     transaction: Transaction, all_transactions: list[Transaction], days: int, n_days_off: int = 0
# ) -> float:
#     """Calculate the percentage of transactions that occur exactly `days` apart."""
#     n_days_apart = get_n_transactions_days_apart(transaction, all_transactions, days, n_days_off)
#     return n_days_apart / len(all_transactions)


# def get_n_transactions_same_day(
#     transaction: Transaction, all_transactions: list[Transaction], n_days_off: int = 0
# ) -> int:
#     """Count the number of transactions that occur on the same day, allowing for an offset of `n_days_off`."""
#     from datetime import datetime
...
#     for t in all_transactions:
#         t_date = datetime.strptime(t.date, "%Y-%m-%d")
#         if abs((t_date - transaction_date).days) <= n_days_off:
#             count += 1
#     return count
...
def get_features(transaction: Transaction, all_transactions: list[Transaction]) -> dict[str, float | int]:
    return {
        # "transaction_amount_variability": get_transaction_amount_variability(all_transactions),
        ...
        #     "avg_gap_between_transactions": get_avg_gap_between_transactions(transaction, all_transactions),
    }
