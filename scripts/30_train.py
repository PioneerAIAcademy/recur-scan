...
from recur_scan.features_felix import get_new_features
...
in_path = "data/input/recur_scan_train.csv"
precomputed_features_path = "data/input/train_features.csv/train_features.csv"
out_dir = "data/output/"
